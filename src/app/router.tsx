...
import { SubscriptionPlanPricingPage } from '@/features/meal-plans/pricing/SubscriptionPlanPricingPage';
import { PackageOptionsPage } from '@/features/meal-plans/package-options/PackageOptionsPage';
import { WeeklyMenuPage } from '@/features/meal-plans/weekly-menu/WeeklyMenuPage';
import { DeliveryCalendarPage } from '@/features/delivery-calendar/DeliveryCalendarPage';
import { HolidaysClosuresPage } from '@/features/delivery-calendar/HolidaysClosuresPage';
import { AuditPage } from '@/features/audit/AuditPage';
import { ModulePage } from '@/features/shared/ModulePage';
import { RoleManagementPage } from '@/features/access-control/RoleManagementPage';
import { UserManagementPage } from '@/features/access-control/UserManagementPage';
import { AppErrorPage, ForbiddenPage, NotFoundPage } from '@/pages/ErrorPages';
export const router=createBrowserRouter([{path:'/login',element:<LoginPage/>},{element:<ProtectedRoute/>,children:[{element:<AdminLayout/>,errorElement:<AppErrorPage/>,children:[{index:true,element:<DashboardPage/>},{path:'meals',element:<MealsPage/>},{path:'meals/new',element:<MealFormPage/>},{path:'meals/:mealId',element:<MealDetailsPage/>},{path:'meals/:mealId/edit',element:<MealFormPage/>},{path:'categories',element:<MasterDataPage resource="meal-categories"/>},{path:'ingredients',element:<MasterDataPage resource="ingredients"/>},{path:'allergens',element:<MasterDataPage resource="allergens"/>},{path:'meal-types',element:<MasterDataPage resource="meal-types"/>},{path:'meal-plans',element:<PlanListPage/>},{path:'meal-plans/new',element:<PlanBuilderPage/>},{path:'meal-plans/:planId/edit',element:<PlanBuilderPage/>},{path:'meal-plans/pricing',element:<SubscriptionPlanPricingPage/>},{path:'admin/package-options',element:<PackageOptionsPage/>},{path:'admin/plan-pricing',element:<SubscriptionPlanPricingPage/>},{path:'admin/weekly-menu',element:<WeeklyMenuPage/>},{path:'admin/meal-plans/:mealPlanId/weekly-menu',element:<WeeklyMenuPage/>},{path:'operations/delivery-calendar',element:<DeliveryCalendarPage/>},{path:'operations/closures',element:<HolidaysClosuresPage/>},{path:'pricing',element:<ModulePage title="Pricing" description="Manage meal, delivery, corporate, and promotional price timelines." endpoint="GET /admin/pricing"/>},{path:'media',element:<ModulePage title="Media library" description="Review uploaded media, translations, captions, dimensions, and active usage." endpoint="GET /admin/media"/>},{path:'audit',element:<AuditPage/>},{path:'settings',element:<ModulePage title="Settings" description="Portal policy, translation requirements, upload limits, and operational configuration belong to backend-controlled settings." endpoint="GET /admin/settings"/>},{path:'roles',element:<RoleManagementPage/>},{path:'users',element:<UserManagementPage/>},{path:'forbidden',element:<ForbiddenPage/>},{path:'*',element:<NotFoundPage/>}]}]}]);
